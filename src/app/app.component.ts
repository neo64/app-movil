...
import {
    MiSaludPage
} from '../pages/mi-salud/mi-salud';
import {
    MiPerfilPage
} from '../pages/mi-perfil/mi-perfil';
import {
    MisDocumentosPage
} from '../pages/mis-documentos/mis-documentos';
import {
    MisCitasPage
} from '../pages/mis-citas/mis-citas';
import {
    ChatPage
} from '../pages/chat/chat';
import {
    SugerenciasPage
} from '../pages/sugerencias/sugerencias';
...
import {
    TabConsultarCitas
} from '../pages/tabConsultarCitas/tabConsultarCitas';
import {
    PedirCitaPage
} from '../pages/pedir-cita/pedir-cita';
import {
    DocumentosContablesPage
} from '../pages/documentos-contables/documentos-contables';
import {
    PresupuestosPage
} from '../pages/presupuestos/presupuestos';
import {
    RecallPage
} from '../pages/recall/recall';
import {
    RecallPasadasPage
} from '../pages/recall-pasadas/recall-pasadas';
import {
    ConsejosPersonalizadosPage
} from '../pages/consejos-personalizados/consejos-personalizados';
import {
    InstruccionesPage
