...
@IonicPage()
@Component({
  selector: "page-documentos-contables",
  templateUrl: "documentos-contables.html"
})
export class DocumentosContablesPage {
  ...
  constructor(
    ...
    this.tituloSubtitulo.titulo = this.translate.instant("DOCUMENTOS_CONTABLES.TITULO");
    this.tituloSubtitulo.subtitulo = this.translate.instant("DOCUMENTOS_CONTABLES.SUBTITULO");
  }
  ...
  openPdf(base64, numDoc) {
    if (base64 == "") {
      this.presentToast(this.translate.instant("DOCUMENTOS_CONTABLES.ERROR_ABRIR_DOC"));
    } else {
      this.showLoading();
      ...
      this.file
        ...
        .then(_ => {
          ...
          this.fileOpener
            ...
            .catch(e => {
              alert(this.translate.instant("DOCUMENTOS_CONTABLES.ERROR_ABRIENDO_ARCHIVO"));
              this.loading.dismiss();
            });
        })
        .catch(err => {
