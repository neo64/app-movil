...
export class MiPerfilPage {
	...
	constructor(private platform: Platform, private file: File, private _CAMERA : Camera, public actionSheetCtrl: ActionSheetController, private domSanitizer: DomSanitizer, private loadingCtrl: LoadingController, public events: Events, private alertCtrl: AlertController, public restProvider: RestProvider, public navCtrl: NavController) {
